...
export default function LeagueManagerPage({
  ...
  const loadWorkspace = useCallback(async () => {
    ...
    setWorkspaceError("");
    try {
      const payload = await DB.getLeagueWorkspace(activeLeagueId);
