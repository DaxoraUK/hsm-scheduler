...
import LeagueClubFinancePanel from "./LeagueClubFinancePanel.jsx";
...
const TABS = [
  ...
  ["finance", "Finance", ReceiptPoundSterling],
...
export default function LeagueClubPortalPage({ leagueId, portal, onRefresh }) {
  ...
  return (
    <div className="mx-auto w-full max-w-[1320px] space-y-5">
      ...
      {tab === "finance" ? <LeagueClubFinancePanel leagueId={leagueId} /> : null}
