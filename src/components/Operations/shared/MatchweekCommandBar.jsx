    ...
    <section className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
      ...
      <div className="p-6 sm:p-7">
        ...
        <div className="mt-5 flex flex-wrap items-center gap-3">
          ...
          <SecondaryButton onClick={onRebuild} disabled={isLocked || rebuildBusy || typeof onRebuild !== "function"}><RefreshCw size={17} className={rebuildBusy ? "animate-spin" : undefined} />{rebuildBusy ? "Rebuilding…" : "Optimise/Rebuild Day"}</SecondaryButton>
