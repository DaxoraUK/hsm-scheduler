...
function buildCalendar(payload = {}) {
  ...
  return [
    "BEGIN:VCALENDAR",
    "VERSION:2.0",
    "PRODID:-//Daxora//Annual Planner//EN",
    "CALSCALE:GREGORIAN",
    "METHOD:PUBLISH",
...
export async function GET(request) {
  try {
    ...
    const payload = await serviceRpc("get_annual_planner_calendar_by_token", { feed_token: token.trim() });
    const calendar = buildCalendar(payload || {});
    return new Response(calendar, {
      status: 200,
      headers: {
        "content-type": "text/calendar; charset=utf-8",
        "content-disposition": "inline; filename=annual-planner-calendar.ics",
